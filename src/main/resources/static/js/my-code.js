...
// 设置模板标题 
sp.title = "Web新生报道管理系统 ";
sp.logo_url = 'img/xk-logo.png';    // 设置logo图标地址   默认值：sa-resources/admin-logo.png
sp.icon_url = 'img/xk-logo.png';    // 设置icon图标地址   默认值：sa-resources/admin-logo.png
...
}else if(student!=null&&student.studentInFo==0) {
	if (student.studentType == 0)
	{
			sp.setMenuList(studentInfo0);
	}
	else
	{
		sp.setMenuList(studentInfo1);
	}

}
else if(student!=null&&student.studentInFo==1)
{

		sp.setMenuList(studentType);
...
if(student!=null) {
	sp.user = {
		username: student.studentName,	// 昵称
		avatar: 'img/xk-logo.png'	// 头像地址
	}
}else if(admin!=null)
{
	sp.user = {
		username: admin.adminUsers,	// 昵称
		avatar: 'img/xk-logo.png'	// 头像地址
	}
}
